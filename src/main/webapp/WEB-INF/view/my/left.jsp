	...
	<div class="list-group">
		<ul class="list-group">
			<li class="list-group-item  text-center list-group-item-info"  id="myArticle" ><a class="channel"
				href="javascript:void(0)"  data="/my/myArticles" >我的文章
			</a></li>
			...
			<li class="list-group-item  text-center"><a class="channel"
				...
				<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/my/goCollect" class="channel">个人收藏</a></li>
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/blog/toBlog" class="list-group-item">写博客</a></li>
		
		<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/my/gopublishPic" class="list-group-item">发布图片集</a></li>
